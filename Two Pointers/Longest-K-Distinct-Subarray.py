...
PROBLEM DESCRIPTION:
    ...
    2. Find the LENGTH of the LONGEST CONTIGUOUS SUBARRAY that contains AT MOST K DISTINCT ELEMENTS


THOUGHT PROCESS:

    1. This is basically a TWO POINTER (SLIDING WINDOW) problem
